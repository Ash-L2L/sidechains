...
void BitcoinGUI::createActions()
{
    ...
    myAssetsAction->setStatusTip(tr("Show BitNames in the wallet"));
    ...
    browseAssetsAction->setStatusTip(tr("Browse all BitNames"));
    ...
    createAssetAction->setStatusTip(tr("Create a new BitName"));
