...
const char * const BITCOIN_CONF_FILENAME = "bitnames.conf";
const char * const BITCOIN_PID_FILENAME = "bitnamesd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "BitNames";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/BitNames";
#else
    // Unix
    return pathRet / ".bitnames";
#endif
#endif
}
