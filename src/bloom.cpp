...
inline bool CBloomFilter::IsRelevantAndUpdate_(const TxType& tx)
{
    bool fFound = false;
...
bool CBloomFilter::IsRelevantAndUpdate(const CTransaction& tx) {
    return CBloomFilter::IsRelevantAndUpdate_(tx);
}

bool CBloomFilter::IsRelevantAndUpdate(const CMainchainTransaction& tx) {
    return CBloomFilter::IsRelevantAndUpdate_(tx);
}
