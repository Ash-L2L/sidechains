...
public:
    ...
    bool RegisterBitName(CTransactionRef& tx, std::string& strFail, const std::string& strName, const uint256& commitment,  const in_addr& in4, const boost::optional<CPubKey>& pubkey, const CAmount& nFee, bool fImmutable = false);
