...
struct MainSignalsInstance {
    ...
    boost::signals2::signal<void (const std::map<uint256, BitNameTransactionData>&, const std::shared_ptr<const CBlock> &, const CBlockIndex *pindex, const std::vector<CTransactionRef>&)> BlockConnected;
...
void CMainSignals::BlockConnected(const std::map<uint256, BitNameTransactionData>& mapAssetData, const std::shared_ptr<const CBlock> &pblock, const CBlockIndex *pindex, const std::shared_ptr<const std::vector<CTransactionRef>>& pvtxConflicted) {
