...
* bitcoin.conf: contains configuration settings for bitnamesd or bitcoin-qt
* bitnamesd.pid: stores the process id of bitnamesd while running
...
* debug.log: contains debug information and general logging generated by bitnamesd or bitcoin-qt
