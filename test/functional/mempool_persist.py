...
By default, bitnamesd will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give bitnamesd a second to reload the mempool
        ...
        self.log.debug("Prevent bitnamesd from writing mempool.dat to disk. Verify that `savemempool` fails")
